...
<div class="scrollable-area">
    <ul>
        ...
        <li class="news-item"><span class="news-date">2026.03</span><span class="news-body">🐧☁️ Excited to receive the <em class="entity-mention" style="--entity-color: #2E96A6; background: #DDF0F3">Tencent Qingyun Scholarship (Student Travel Grant)</em>.</span></li>
